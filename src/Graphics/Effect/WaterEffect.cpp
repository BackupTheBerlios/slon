        ...
        switch (technique)
        {
            case Renderer::FORWARD_RENDERING:
            {
                ...
                detail::Pass::UNIFORM_DESC uniformDesc;
                {
                    ...
                    uniformDesc.uniformName   = "depthParams";
                    uniformDesc.parameterName = "depthParams";
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "eyePosition";
                    uniformDesc.parameterName = "eyePosition";
                    desc.uniforms.push_back(uniformDesc);
                    ...
                    uniformDesc.parameterName = "lightDirectionAmbient";
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "depthParams";
                    uniformDesc.parameterName = "depthParams";
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "sharpness";
                    uniformDesc.parameter     = sharpnessBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "distanceSmoothness";
                    uniformDesc.parameter     = distanceSmoothnessBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "waterTransparency";
                    uniformDesc.parameter     = waterTransparencyBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "squeezeParams";
                    uniformDesc.parameter     = squeezeParamsBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "surfaceSize";
                    uniformDesc.parameter     = surfaceSizeBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "surfaceCorners";
                    uniformDesc.parameter     = projectedGridCornersBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "worldViewMatrix";
                    uniformDesc.parameter     = worldViewMatrixBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "reflectionMatrix";
                    uniformDesc.parameter     = reflectionMatrixBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "heightMap";
                    uniformDesc.parameter     = heightMapBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "normalMap";
                    uniformDesc.parameter     = normalMapBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "reflectMap";
                    uniformDesc.parameter     = reflectMapBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "refractMap";
                    uniformDesc.parameter     = refractMapBinder.get();
                    desc.uniforms.push_back(uniformDesc);
                    uniformDesc.uniformName   = "depthMap";
                    uniformDesc.parameter     = depthMapBinder.get();
                    desc.uniforms.push_back(uniformDesc);
