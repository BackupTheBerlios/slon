...
IF (NOT SLON_ENGINE_CONFIGURE_INTRUSIVE)
    OPTION (SLON_ENGINE_BUILD_C4D_EXPORT_PLUGIN OFF)
	MESSAGE ( "Build C4D export plugin: " ${SLON_ENGINE_BUILD_C4D_EXPORT_PLUGIN} )
...
OPTION_DEPENDENT_ON_PACKAGE ( SLON_ENGINE_USE_PYTHON "Set ON to enable python API" PYTHONINTERP_FOUND AND GCCXML AND PYTHONLIBS_FOUND )
MESSAGE ( "Use python: " ${SLON_ENGINE_USE_PYTHON} )

# check settings
IF (NOT SLON_ENGINE_USE_PYTHON AND SLON_ENGINE_BUILD_C4D_EXPORT_PLUGIN)
	MESSAGE (FATAL_ERROR "You must build with SLON_ENGINE_USE_PYTHON in order to build C4D export plugin") 
ENDIF (NOT SLON_ENGINE_USE_PYTHON AND SLON_ENGINE_BUILD_C4D_EXPORT_PLUGIN)
